...
@Configuration
@EnableJpaRepositories("com.usemodj.nodesoft.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("com.usemodj.nodesoft.repository.search")
public class DatabaseConfiguration implements EnvironmentAware {
    ...
    @ConditionalOnMissingClass(name = "com.usemodj.nodesoft.config.HerokuDatabaseConfiguration")

...
class ProductGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Product entity")
        ...
        .repeat(2) {
            ...
            .put("/api/products")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "name":"SAMPLE_TEXT", "properties":"SAMPLE_TEXT", "description":"SAMPLE_TEXT", "availableDate":"2020-01-01T00:00:00.000Z", "deletedDate":"2020-01-01T00:00:00.000Z", "slug":"SAMPLE_TEXT", "metaDescription":"SAMPLE_TEXT", "metaKeywords":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
